...
{
    public static class AProcessHelper
    {
        ...
        /// </summary>
        public static IEnumerable<IntPtr> TopLevelWindows => AWindowHelper.EnumTopLevelWindows();

        /// <summary>
        ///     Gets all the windows on the screen.
        /// </summary>
        public static IEnumerable<IntPtr> Windows => AWindowHelper.EnumAllWindows();
        ...
        {
            return
                Windows.Where(window => AWindowHelper.GetWindowText(window).Contains(windowTitle))
