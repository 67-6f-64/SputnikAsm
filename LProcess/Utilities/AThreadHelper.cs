...
namespace SputnikAsm.LProcess.Utilities
{
    ...
    /// </summary>
    public static class AThreadHelper
    {
        /// <summary>
        ...
        public static ASafeMemoryHandle OpenThread(ThreadAccessFlags accessFlags, int threadId)
        {
            // Open the thread
        ...
        public static int ResumeThread(ASafeMemoryHandle threadHandle)
        {
            // Check if the handle is valid
            AHandleManipulator.ValidateAsArgument(threadHandle, "threadHandle");
