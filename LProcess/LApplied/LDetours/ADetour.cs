...
namespace SputnikAsm.LProcess.LApplied.LDetours
{
    ...
    /// </summary>
    public class ADetour : IAComplexApplied
    {
        /// <summary>
        ...
        /// </summary>
        private IAMemory ProcessMemory { get; }
        ...
        /// <summary>
        ///     Gets a value indicating whether the <see cref="ADetour" /> is disposed.
        /// </summary>
        public bool IsDisposed { get; internal set; }

        /// <summary>
        ///     Gets a value indicating whether the <see cref="ADetour" /> must be disposed when the Garbage Collector collects the
        ///     object.
        /// </summary>
        ...
        ///     case, it will disable the <see cref="ADetour" /> instance and suppress the finalizer.
        /// </summary>
        public void Dispose()
        {
            if (IsDisposed)
