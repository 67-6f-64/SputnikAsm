...
namespace SputnikAsm.LProcess.LThreads
{
    ...
    /// </summary>
    public class ARemoteThread : IEquatable<ARemoteThread>, IARemoteThread
    {
        private readonly IAMarshalledValue _parameter;
            ...
            get
            {
                ...
                try
                {
                    ...
                    if (!isSuspended)
                        Suspend();
                    // Get the context
                    return AThreadHelper.GetThreadContext(Handle,
            ...
            set
            {
                ...
                try
                {
                    ...
                    if (!isSuspended)
                        Suspend();
                    // Set the context
                    AThreadHelper.SetThreadContext(Handle, value);
                }
                finally
                {
                    // Resume the thread if it wasn't suspended
        ...
        /// </summary>
        public ASafeMemoryHandle Handle { get; }
        ...
        /// <summary>
        ///     Releases all resources used by the <see cref="ARemoteThread" /> object.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ARemoteThread) obj);
        }

        public static bool operator ==(ARemoteThread left, ARemoteThread right)
        {
