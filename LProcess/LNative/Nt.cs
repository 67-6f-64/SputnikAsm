...
namespace SputnikAsm.LProcess.LNative
{
    public static class Nt
    {
        ...
        [DllImport("ntdll.dll")]
        public static extern int NtQueryInformationProcess(ASafeMemoryHandle processHandle,
        ...
        /// <returns>Returns an NTSTATUS success or error code. (STATUS_SUCCESS = 0x0).</returns>
        [DllImport("ntdll.dll")]
        public static extern int NtQueryInformationThread(ASafeMemoryHandle hwnd, int infoclass,
