...
namespace SputnikAsm.LProcess.LNative
{
    public static class Kernel32
    {
        ...
        [DllImport("kernel32.dll")]
        internal static extern void GetNativeSystemInfo(out SystemInfo input);
        ...
        public static extern unsafe ASafeLoadLibrary LoadLibraryExW([In] string lpwLibFileName, [In] void* hFile,
            [In] int dwFlags);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int SuspendThread(ASafeMemoryHandle hThread);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool TerminateThread(ASafeMemoryHandle hThread, int dwExitCode);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern IntPtr VirtualAllocEx(ASafeMemoryHandle hProcess, IntPtr lpAddress, int dwSize,
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool VirtualFreeEx(ASafeMemoryHandle hProcess, IntPtr lpAddress, int dwSize,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool VirtualProtectEx(ASafeMemoryHandle hProcess, IntPtr lpAddress, int dwSize,
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern WaitValues WaitForSingleObject(ASafeMemoryHandle hHandle, uint dwMilliseconds);
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WriteProcessMemory(ASafeMemoryHandle hProcess, IntPtr lpBaseAddress, byte[] lpBuffer,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool SetThreadContext(ASafeMemoryHandle hThread,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int ResumeThread(ASafeMemoryHandle hThread);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern ASafeMemoryHandle OpenProcess(ProcessAccessFlags dwDesiredAccess,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern ASafeMemoryHandle OpenThread(ThreadAccessFlags dwDesiredAccess,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool GetExitCodeThread(ASafeMemoryHandle hThread, out IntPtr lpExitCode);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int GetProcessId(ASafeMemoryHandle hProcess);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool GetThreadContext(ASafeMemoryHandle hThread, ref ThreadContext lpContext);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool GetThreadSelectorEntry(ASafeMemoryHandle hThread, int dwSelector,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int GetThreadId(ASafeMemoryHandle hThread);
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern ASafeMemoryHandle CreateRemoteThread(ASafeMemoryHandle hProcess, IntPtr lpThreadAttributes,
