...
namespace SputnikAsm.LProcess.LAssembly
{
    ...
    /// </summary>
    public class AAssemblyTransaction : IDisposable, IAAssemblyTransaction
    {
        private readonly IAAssemblyFactory _assemblyFactory;
        ...
        /// <summary>
        ///     Releases all resources used by the <see cref="AAssemblyTransaction" /> object.
        /// </summary>
