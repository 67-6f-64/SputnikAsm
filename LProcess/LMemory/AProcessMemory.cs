...
namespace SputnikAsm.LProcess.LMemory
{
    ...
    /// </summary>
    /// <seealso cref="IAMemory" />
    public abstract class AProcessMemory : IAMemory
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="AProcessMemory" /> class.
        /// </summary>
        /// <param name="handle">The open handle to the process which contains the memory of interest.</param>
        protected AProcessMemory(ASafeMemoryHandle handle)
        {
            Handle = handle;
        }
