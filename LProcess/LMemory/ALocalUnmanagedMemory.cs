...
namespace SputnikAsm.LProcess.LMemory
{
    ...
    /// </summary>
    public class ALocalUnmanagedMemory : IDisposable
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ALocalUnmanagedMemory" /> class, allocating a block of memory in the
        ///     local process.
        /// </summary>
        /// <param name="size">The size to allocate.</param>
        public ALocalUnmanagedMemory(int size)
        {
            // Allocate the memory
            Size = size;
        ...
        /// <summary>
        ///     Releases the memory held by the <see cref="ALocalUnmanagedMemory" /> object.
        /// </summary>
