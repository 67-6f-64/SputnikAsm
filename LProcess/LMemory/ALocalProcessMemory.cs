...
namespace SputnikAsm.LProcess.LMemory
{
    ...
    public class ALocalProcessMemory : AProcessMemory
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ALocalProcessMemory" /> class.
        /// </summary>
        /// <param name="handle">The process.</param>
        public ALocalProcessMemory(ASafeMemoryHandle handle) : base(handle)
        {
        }
