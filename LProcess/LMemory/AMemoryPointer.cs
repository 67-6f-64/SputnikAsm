...
namespace SputnikAsm.LProcess.LMemory
{
    ...
    /// </summary>
    public class AMemoryPointer : IEquatable<AMemoryPointer>, IAPointer
    {
        /// <summary>
        ...
        /// <summary>
        ///     The reference of the <see cref="IAMemory" /> object.
        /// </summary>
        public AProcessSharp Process { get; protected set; }
        ...
        /// <summary>
        ///     Gets if the <see cref="AMemoryPointer" /> is valid.
        /// </summary>
        ...
        public AMemoryProtection ChangeProtection(ASafeMemoryHandle handle, int size,
            MemoryProtectionFlags protection = MemoryProtectionFlags.ExecuteReadWrite, bool mustBeDisposed = true)
        {
            return new AMemoryProtection(handle, BaseAddress, size, protection, mustBeDisposed);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AMemoryPointer) obj);
        }
        ...
        public static bool operator ==(AMemoryPointer left, AMemoryPointer right)
        {
