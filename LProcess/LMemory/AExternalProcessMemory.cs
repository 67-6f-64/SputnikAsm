...
namespace SputnikAsm.LProcess.LMemory
{
    ...
    /// </summary>
    /// <seealso cref="AProcessMemory" />
    public class AExternalProcessMemory : AProcessMemory
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="AExternalProcessMemory" /> class.
        /// </summary>
        /// <param name="handle">The open handle to the process which contains the memory of interest.</param>
        public AExternalProcessMemory(ASafeMemoryHandle handle) : base(handle)
        {
        }
