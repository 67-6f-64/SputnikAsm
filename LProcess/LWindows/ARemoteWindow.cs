...
namespace SputnikAsm.LProcess.LWindows
{
    ...
    /// </summary>
    public class ARemoteWindow : IEquatable<ARemoteWindow>, IAWindow
    {
        ...
        /// </summary>
        protected IEnumerable<IntPtr> ChildrenHandles => AWindowHelper.EnumChildWindows(Handle);

        /// <summary>
        ///     Returns a value indicating whether this instance is equal to a specified object.
        /// </summary>
        public bool Equals(ARemoteWindow other)
        {
        ...
        /// </summary>
        public IEnumerable<IAWindow> Children
        {
            get { return ChildrenHandles.Select(handle => new ARemoteWindow(ProcessPlus, handle)); }
        }

        /// <summary>
        ///     Gets the class name of the window.
        /// </summary>
        public string ClassName => AWindowHelper.GetClassName(Handle);
        ...
        /// </summary>
        public bool IsActivated => AWindowHelper.GetForegroundWindow() == Handle;
        ...
        /// </summary>
        public IAKeyboard Keyboard { get; set; }

        /// <summary>
        ///     Tools for managing a virtual mouse in the window.
        /// </summary>
        public IAMouse Mouse { get; set; }
        ...
        {
            get { return AWindowHelper.GetWindowPlacement(Handle); }
            set { AWindowHelper.SetWindowPlacement(Handle, value); }
        }
        ...
        public WindowStates State
        {
            ...
            set { AWindowHelper.ShowWindow(Handle, value); }
        }
        ...
        public string Title
        {
            get { return AWindowHelper.GetWindowText(Handle); }
            set { AWindowHelper.SetWindowText(Handle, value); }
        }

        /// <summary>
        ///     Gets the thread of the window.
        /// </summary>
        public IARemoteThread Thread => ProcessPlus.ThreadFactory.GetThreadById(AWindowHelper.GetWindowThreadId(Handle));
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((ARemoteWindow) obj);
        }

        public static bool operator ==(ARemoteWindow left, ARemoteWindow right)
        {
